...
namespace KoreanSecrets.Domain.Migrations
{
    ...
    [Migration("20240717185701_RemoveProductsWaitingForStock")]
    partial class RemoveProductsWaitingForStock
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KoreanSecrets.Domain.Entities.AdminBucket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("KoreanSecrets.Domain.Entities.AppFile", b =>
                {
                    ...
                    b.HasIndex("VolumePhotoId");

                    b.ToTable("Files");
                });

            modelBuilder.Entity("KoreanSecrets.Domain.Entities.Banners.Banner", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("KoreanSecrets.Domain.Entities.Banners.BottomBanner", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("BottomBanners");
                });

            modelBuilder.Entity("KoreanSecrets.Domain.Entities.Banners.BottomBannerPhoto", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("BottomBannerId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("BottomBannerId");

                    b.HasIndex("PhotoId");

                    b.ToTable("BottomBannerPhotos");
                });
            ...
            modelBuilder.Entity("KoreanSecrets.Domain.Entities.BucketProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("AdminBucketId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("KoreanSecrets.Domain.Entities.FeedbackReply", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("KoreanSecrets.Domain.Entities.ProductDemand", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("KoreanSecrets.Domain.Entities.ProductPromocode", b =>
                {
            ...
            modelBuilder.Entity("KoreanSecrets.Domain.Entities.ProductUser", b =>
                {
            ...
            modelBuilder.Entity("KoreanSecrets.Domain.Entities.Promotion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("KoreanSecrets.Domain.Entities.PurchasedProduct", b =>
                {
                    ...
                    b.Property<string>("ProductIdentify")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("VolumeIdentify")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("KoreanSecrets.Domain.Entities.SiteSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<bool>("EnableLiqPay")
                        .HasColumnType("bit");

                    b.Property<bool>("EnablePayByCard")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("KoreanSecrets.Domain.Entities.AdminBucket", b =>
                {
                    b.HasOne("KoreanSecrets.Domain.Entities.User", "User")
                        .WithOne("AdminBucket")
                        .HasForeignKey("KoreanSecrets.Domain.Entities.AdminBucket", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KoreanSecrets.Domain.Entities.AppFile", b =>
                {
                    b.HasOne("KoreanSecrets.Domain.Entities.Banners.Banner", "Banner")
                        .WithOne("BannerPhoto")
                    ...
                    b.HasOne("KoreanSecrets.Domain.Entities.Volume", "VolumePhoto")
                        .WithMany("Photos")
                        .HasForeignKey("VolumePhotoId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("KoreanSecrets.Domain.Entities.Banners.Banner", b =>
                {
                    b.HasOne("KoreanSecrets.Domain.Entities.Brand", "Brand")
                        .WithOne()
                        .HasForeignKey("KoreanSecrets.Domain.Entities.Banners.Banner", "BrandId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("KoreanSecrets.Domain.Entities.Banners.BottomBannerPhoto", b =>
                {
                    b.HasOne("KoreanSecrets.Domain.Entities.Banners.BottomBanner", "BottomBanner")
                        .WithMany("Photos")
                        .HasForeignKey("BottomBannerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("KoreanSecrets.Domain.Entities.AppFile", "Photo")
                        .WithMany()
                        .HasForeignKey("PhotoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BottomBanner");
            ...
            modelBuilder.Entity("KoreanSecrets.Domain.Entities.BucketProduct", b =>
                {
                    b.HasOne("KoreanSecrets.Domain.Entities.AdminBucket", "AdminBucket")
                        .WithMany("BucketProducts")
                        .HasForeignKey("AdminBucketId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("KoreanSecrets.Domain.Entities.FeedbackReply", b =>
                {
                    b.HasOne("KoreanSecrets.Domain.Entities.Feedback", "Feedback")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("KoreanSecrets.Domain.Entities.ProductUser", b =>
                {
                    b.HasOne("KoreanSecrets.Domain.Entities.Product", "Likes")
                        .WithMany("Likes")
                        .HasForeignKey("LikesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("KoreanSecrets.Domain.Entities.User", "Likes1")
                        .WithMany("Likes")
